          ...
          <div class="mx-auto my-20 px-4">
            <div class="text-center">
              ...
              <div class="mt-6 flex justify-center">
                <a href="https://github.com/Silent-wqh/medicine" class="flex items-center gap-1  bg-secondary-700 px-4 py-2 text-sm font-normal text-white shadow-sm transition-all hover:bg-secondary-800 rounded-full">
